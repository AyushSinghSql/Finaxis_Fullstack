...
public interface IProjPlanService
{
    ...
    Task<PagedResponse<PlProjectPlan>> GetProjectPlansPaged(int userId, string role, string projectID, string? status, string fetchNewBussiness, int pageNumber, int pageSize);
...
public class ProjPlanService : IProjPlanService
{
    ...
    public async Task<PagedResponse<PlProjectPlan>> GetProjectPlansPaged(int userId, string role, string projectID, string? status, string fetchNewBussiness, int pageNumber, int pageSize)
    {
        return await _projPlanRepository.GetProjectPlansPaged(userId, role, projectID, status, fetchNewBussiness,pageNumber,pageSize);
    }
